...
/// Thrown when proof submission is refused because the quote has expired.
/// Only applies to the signed-transaction-HEX flow.
class OpenCryptoPayQuoteExpiredException implements Exception {
  OpenCryptoPayQuoteExpiredException([this.message]);
  final String? message;
